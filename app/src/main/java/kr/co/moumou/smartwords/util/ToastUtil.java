...
public class ToastUtil {
	...
	public static void showInputCorrect(Context context) {
		if(!isCanShow(context)){
			return;
		}
		...
		String str = context.getResources().getString(R.string.template_input_correct);
		
		toast = Toast.makeText(context, str, DEFAULT_DURATION);
		toast.show();
	}
}
